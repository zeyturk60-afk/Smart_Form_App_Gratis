...
private void BtnGiris_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection baglanti = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    if (oku.Read())
                    {
                        MessageBox.Show("Giriş Başarılı! Gratis Dünyasına Hoş Geldiniz.", "Süslü Hoşgeldin", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        MessageBox.Show("Hatalı kullanıcı adı veya şifre!", "Eyvah!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                catch (Exception ex)
                {
